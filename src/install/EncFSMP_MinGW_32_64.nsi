...
Section "Pismo File Mount" Section_PFM
	...
	IfFileExists "$TEMP\pfm-171-encfsmp-win.exe" ErrorPFMFileExists
	DetailPrint "Installing Pismo File Mount"
	File "res\pfm-171-encfsmp-win.exe"
	nsExec::ExecToLog '"$TEMP\pfm-171-encfsmp-win.exe" install'
	Delete "$TEMP\pfm-171-encfsmp-win.exe"
